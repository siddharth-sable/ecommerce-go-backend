...
import (
	...
	"github.com/siddharth-sable/ecommerce-go/models"
	generate "github.com/siddharth-sable/ecommerce-go/tokens"
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refershToken, _ := generate.TokenGenerator(*user.Email, *user.First_Name, *user.Last_Name, user.User_ID)
		user.Token = &token
